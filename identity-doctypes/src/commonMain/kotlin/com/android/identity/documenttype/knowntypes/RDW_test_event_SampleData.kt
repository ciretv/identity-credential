...
internal object RDW_test_event_SampleData {
    ...
    const val RESIDENT_ADDRESS = "De Heyderweg 2, Leiden"
    const val RESIDENT_COUNTRY = "NL"  // Note: ZZ is a user-assigned country-code as per ISO 3166-1
    const val RESIDENT_STATE = "Zuid-Holland"
    const val RESIDENT_CITY = "Leiden"
    const val RESIDENT_POSTAL_CODE = "2314 XZ"
    const val RESIDENT_STREET = "De Heyderweg"
    const val RESIDENT_HOUSE_NUMBER = "2"
    const val PERSONAL_ADMINISTRATIVE_NUMBER = "9876543210"
    ...
    const val EMAIL_ADDRESS = "erika@mustermann.nl"
    const val MOBILE_PHONE_NUMBER = "+31717993005"
    const val EXPIRY_DATE = "2028-09-01"
    const val ISSUING_AUTHORITY_EU_PID = "Explicit Selection"
    const val ISSUING_COUNTRY = "NL"  // Note: ZZ is a user-assigned country-code as per ISO 3166-1
    const val DOCUMENT_NUMBER = "0123456789"
    const val ISSUANCE_DATE = "2025-01-28"
    const val AGE_OVER_18 = true
    const val AGE_IN_YEARS = 38
